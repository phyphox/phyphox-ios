...
let kBackgroundColor = UIColor(white: 0.251, alpha: 1.0)
let kDarkBackgroundColor = UIColor(white: 0.125, alpha: 1.0)
let kLightBackgroundColor = UIColor(white: 0.376, alpha: 1.0)
